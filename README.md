...
Available features: blosum_indices fasgai_vectors ms_whim_scores protfp_descriptors st_scales t_scales vhse_scale z_scales (and more, refer to https://github.com/althonos/peptides.py)
...
$ python scripts/finetune.py \
	-obj sv -default -f True -i data/fluorescence.csv \
	-o results/esm2_t6_8M_UR50D_sv_full_default -cp facebook/esm2_t6_8M_UR50D -nt1 3 -nt2 3

$ python scripts/finetune.py \
	-obj mlm -default -f True -i data/fluorescence_homologs.fasta \
	-o results/esm2_t6_8M_UR50D_mlm_full_default -cp facebook/esm2_t6_8M_UR50D -nt1 3 -nt2 3
